...
void MyTestFunction(void)
{
	...
	AddMoveToBoard(board8, 6, 'W', 2, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'E', 0, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'E', 1, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'E', 4, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'E', 5, 1, &rowPos, &colPos);
	...
	InitialiseBoard(board8, 6);
	AddMoveToBoard(board8, 6, 'N', 2, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'N', 2, 1, &rowPos, &colPos);
